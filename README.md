...
**Direct download**:
Download the latest [`Logicle.Transform.mltbx` file](https://github.com/harleyday/logicleTransform.m/releases/download/v1.1/logicleTransform.m.mltbx). Install this from MATLAB by double-clicking on the file.
