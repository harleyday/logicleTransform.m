...
An implementation in R (which actually uses the compiled C/C++ code by the above authors is available from Bioconductor, in the "flowCore" package. To install this package in R, open R and enter:
```R
